...
class OrderAdmin(object):
    list_display = ['id', 'user', 'goods', 'number', 'create_time', 'motorcycle_type', 'License_plate',
                    ...
                    'vehicle_and_vessel_tax','sale_percentage','compulsory_insurance_rebate_percentage',
                    'rebate_amount','compulsory_rebate_amount','actual_slaes_section', 'real_price',
                    'incoming_slaes_section', 'is_received', 'receipt_time', 'outstanding_corporation',
                    'profit','advances','cash_in_hand']
